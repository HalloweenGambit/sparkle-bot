...
import { compareMessages, findMessage, formatMessage, getChangedFields, loadMessage, } from '../../utils/messagesUtils.js';
import { Messages } from '../../db/schema.js';
import { eq } from 'drizzle-orm';
export const saveMessage = async (guildId, channelId, messageId) => {
    try {
...
export const updateMessage = async (guildId, channelId, discordId) => {
    try {
        let db = await dbClient;
...
export const deleteMessage = async (discordId) => {
