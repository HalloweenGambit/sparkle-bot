...
export const mockGuildsFetch = vi.fn(async (id) => {
    const servers = [
        {
...
export const mockDiscordMessage = vi.fn((content = "Is this project open source?", reply = "yes it is, here are the links") => {
    return {
        // returns Snowflake
